...
Animal::Animal(const char *name, const uint8_t age, const uint8_t weight, const uint8_t height)//khai bao tuong minh
{
    Animal::age = age;
...
{
    /* code */
    Animal Meo("Meo", 2, 15, 20);
    Animal Cho("Cho", 4, 6, 4);
